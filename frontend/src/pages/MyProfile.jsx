...
const MyProfile = () => {
  //destructing the userData and setUserData from AppContext
      ...
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {isEdit ? (
              <input
                className="wmax-w-28 bg-gray-100"
                type="date"
        ...
        <div className="mt-10">
          {isEdit ? (
            <button
              className="hover:bg-primary hover:text-white transition-all duration-300 border border-primary px-8 py-2 rounded-full"
